...
# zip = unique(EV_data$zip)Add commentMore actions
# set.seed(100)
# zip100 = sample(zip, 100)
# EV_data_100 = EV_data[EV_data$zip %in% zip100,  ] 
# 
# #spaghetti plot
# ggplot(EV_data_100, aes(x = yr, y = Age_Adjusted_Rate_of_Asthma_ED_Visit_Rate, group = zip)) +
#   geom_line(color = "gray") +
#   labs(
#     title = "Asthma ED Visit Rate by Zip Code (Spaghetti Plot)",
#     x = "Year",
#     y = "ED Visit Rate"
#   )
# 
...
# ```{r}
# #spaghetti plot
# ggplot(EV_data, aes(x = yr, y = , group = zip)) +
#   geom_line(color = "gray") +
#   labs(
#     title = "Asthma ED Visit Rate by Zip Code (Spaghetti Plot)",
#     x = "Year",
...
# result1 = t.test(data1,data2, alternative ="two.sided", conf.level = 0.95)
# result1$conf.int
# result1
# 
...
# use generalized additive mixed model, random intercept 

```
```{r}
#paste("Length:",length(unique(EV_data$zip)))
#
#paste("Mean of population:", mean(EV_data$pop))
#paste("Paste of population:", max(EV_data$pop))
